...
<?php
/*
Plugin Name: Orto Bundle Selector IT
...
function gck_render_bundle_selector() {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter-it', 'orto-magliette-it', 'orto-boxer-it' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <?php endif; ?>
        ...
        <?php
    // Your extra conditional style block (kept)
    if (  has_term( array( 'orto-starter-it'), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <div class="gck-benefits-box">
        <ul class="gck-benefits-list">
            <?php if ( !has_term( array( 'orto-boxer-it', 'orto-boxer-it2', 'starter-pacchetti-it' ), 'product_cat', $product_id ) ) : ?>
                <li><span class="gck-check">✔</span> <strong>Vestibilità perfetta</strong></li>
            <?php endif; ?>

            <li><strong>✔ Materiali premium taglio preciso</strong></li>
            <li><strong>✔ Comfort senza compromessi</strong></li>

            <?php if ( has_term( array( 'orto-starter-it' ), 'product_cat', $product_id ) ) : ?>
                <li style="color: #c00;"><strong>✔ Pacchetto starter disponibile solo una volta per persona</strong></li>
                <li style="color: #c00;"><strong>✔ Limitato a 1.000 pacchetti </strong></li>
            <?php endif; ?>
        </ul>
    ...
    <div class="gck-top-banner-wrap">
        <?php if ( has_term( array( 'orto-starter-it' ), 'product_cat', $product_id ) ) : ?>
           ...
           <!-- <span>Più pezzi, più risparmio!</span>-->
           <span>Prendi il tuo esclusivo<br/> pacchetto starter</span>
        </div>
    ...
    <?php if ( has_term( array( 'orto-starter-it' ), 'product_cat', $product_id ) ) : ?>
        <div class="dev-banner" data-total="1000" data-sold="354">
            <div class="dev-banner__text">
                ...
                <span>Quantità limitata <b class="sold">0</b> / <b class="total">0</b> (Ancora <b class="remain">0</b> pezzi)</span>
            </div>
    ...
    && !has_term( array( 'starter-pacchetti-it' ), 'product_cat', $product_id ) 
...
<div class="bundle-total-line">
    ...
    <span class="line-total"><?php echo number_format( (float) $data['total'], 2 ); ?>€</span>
                ...
                <div class="bundle-pairs <?php echo $is_default ? '' : 'hidden'; ?>"
                    ...
                    <small style="display: block; line-height: 1;"><?php esc_html_e( 'Offriamo 30 giorni di rimborso o cambio gratuito del prodotto – acquisti senza pensieri!
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (!valid) {
            e.preventDefault();
            alert('Per favore, seleziona colore e taglia per ogni set.');
        }
    });
