...
<?php
/*
Plugin Name: Orto Bundle Selector SK
...
function gck_render_bundle_selector() {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter-sk', 'orto-tricka-sk', 'orto-boxerky-sk' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <?php endif; ?>
        ...
        <?php
    // Your extra conditional style block (kept)
    if (  has_term( array( 'orto-starter-sk'), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <div class="gck-benefits-box">
        <ul class="gck-benefits-list">
            <?php if ( !has_term( array( 'orto-boxerky-sk', 'orto-boxerky-sk2', 'starter-baliky-sk' ), 'product_cat', $product_id ) ) : ?>
                <li><span class="gck-check">✔</span> <strong>Perfektné sadnutie</strong></li>
            <?php endif; ?>

            <li><strong>✔ Prémiové materiály presný strih</strong></li>
            <li><strong>✔ Pohodlie bez kompromisov</strong></li>

            <?php if ( has_term( array( 'orto-starter-sk' ), 'product_cat', $product_id ) ) : ?>
                <li style="color: #c00;"><strong>✔ Štartovací balík dostupný len raz na osobu</strong></li>
                <li style="color: #c00;"><strong>✔ Limitované na 1 000 balíkov </strong></li>
            <?php endif; ?>
        </ul>
    ...
    <div class="gck-top-banner-wrap">
        <?php if ( has_term( array( 'orto-starter-sk' ), 'product_cat', $product_id ) ) : ?>
           ...
           <!-- <span>Viac kusov, väčšia úspora!</span>-->
           <span>Vezmite si svoj exkluzívny<br/> štartovací balík</span>
        </div>
        ...
        ?>
            <label style="position: relative; <?php if ( ($loop_index == 1 ||  $loop_index == 3) && ! $show_group_titles) : ?> margin-top: 25px;  <?php endif; ?>"
                ...
                <?php if ( ! $show_group_titles ) : ?>
                    <?php if ( $loop_index == 1 ) : ?>
                        <div class="gck-popular-badge">Najpopulárnejšie 🔥</div>
                    <?php endif; ?>

                    <?php if ( $loop_index == 3 ) : ?>
                        <div class="gck-popular-badge-2">Najlepšia cena 🔥</div>
                    <?php endif; ?>
                <?php endif; ?>
    ...
    && !has_term( array( 'starter-baliky-sk' ), 'product_cat', $product_id ) 
...
<div class="bundle-total-line">
    ...
    <span class="line-total"><?php echo number_format( (float) $data['total'], 2 ); ?>€</span>
                ...
                <div class="bundle-pairs <?php echo $is_default ? '' : 'hidden'; ?>"
                    ...
                    <small style="display: block; line-height: 1;"><?php esc_html_e( 'Ponúkame 30 dní na vrátenie peňazí alebo bezplatnú výmenu produktu – bezstarostný nákup!
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (!valid) {
            e.preventDefault();
            alert('Prosím, vyberte farbu a veľkosť pre každý set.');
        }
    });
