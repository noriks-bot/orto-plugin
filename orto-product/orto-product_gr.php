...
function gck_render_bundle_selector() {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter-gr', 'orto-mployzes-gr', 'orto-boxer-gr' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <?php endif; ?>
        ...
        <?php
    // Your extra conditional style block (kept)
    if (  has_term( array( 'orto-starter-gr'), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <div class="gck-top-banner-wrap">
        <?php if ( has_term( array( 'orto-starter-gr' ), 'product_cat', $product_id ) ) : ?>
           ...
           <!-- <span>Περισσότερα τεμάχια, μεγαλύτερη εξοικονόμηση!</span>-->
